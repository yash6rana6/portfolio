        ...
        <div className={HeaderCSS.hero}>
          ...
          <div className={HeaderCSS.hero_info}>
            ...
            <div className={HeaderCSS.social_icons}>
              ...
              <a href="https://www.linkedin.com/in/yash-deep-singh-17b012303?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank">
                <i className="fa-brands fa-linkedin"></i>
              </a>
              <a href="https://www.facebook.com/profile.php?id=100048388841485" target="_blank">
                <i className="fa-brands fa-facebook"></i>
              </a>
              <a href="https://github.com/yash6rana6" target="_blank">
